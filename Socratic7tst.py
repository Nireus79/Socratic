...
#     detailed_question = agent.adapt_question_complexity(detailed_response, "technical")
#                         ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
# AttributeError: 'SocraticCounselorAgent' object has no attribute 'adapt_question_complexity'
#
# C:\Users\themi\AppData\Local\Programs\Python\Python313\Lib\unittest\case.py:606: RuntimeWarning: coroutine 'TestAdvancedRAGFeatures.test_async_knowledge_retrieval' was never awaited
...
#     shutil.rmtree(self.temp_dir)
#     ~~~~~~~~~~~~~^^^^^^^^^^^^^^^
#   File "C:\Users\themi\AppData\Local\Programs\Python\Python313\Lib\shutil.py", line 790, in rmtree
#     return _rmtree_unsafe(path, onexc)
#   File "C:\Users\themi\AppData\Local\Programs\Python\Python313\Lib\shutil.py", line 629, in _rmtree_unsafe
#     onexc(os.unlink, fullname, err)
#     ~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^
#   File "C:\Users\themi\AppData\Local\Programs\Python\Python313\Lib\shutil.py", line 625, in _rmtree_unsafe
#     os.unlink(fullname)
#     ~~~~~~~~~^^^^^^^^^^
...
#     question = agent.generate_domain_specific_question(domain_context)
#                ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
# AttributeError: 'SocraticCounselorAgent' object has no attribute 'generate_domain_specific_question'
#
...
#     current_version = db.get_schema_version()
#                       ^^^^^^^^^^^^^^^^^^^^^
# AttributeError: 'ProjectDatabase' object has no attribute 'get_schema_version'
#
...
#     agent.notify_project_update(project_update)
#     ^^^^^^^^^^^^^^^^^^^^^^^^^^^
# AttributeError: 'SystemMonitorAgent' object has no attribute 'notify_project_update'
#
# Loading knowledge base...
# Added knowledge entry: software_architecture_patterns
# Added knowledge entry: python_best_practices
...
# ✓ Knowledge base loaded (5 entries)
# ✓ Socratic RAG System v7.0 initialized successfully!
# [23:22:50] ProjectManager: Created project 'Collaboration Test Project' with ID 2bd5a2ea-e03e-4ed4-aceb-fa3e9e84b8f6
# [23:22:50] ProjectManager: Added collaborator 'collaborator1' to project 'Collaboration Test Project'
...
# ✓ Knowledge base loaded (5 entries)
# ✓ Socratic RAG System v7.0 initialized successfully!
# [23:22:53] ProjectManager: Created project 'Test Journey Project' with ID 79704cf2-c3f8-449a-bf72-105c51bf36e1
# [23:22:53] ProjectManager: Saved project 'Test Journey Project'
# [23:22:53] ProjectManager: Loaded project 'Test Journey Project'
...
# ✓ Knowledge base loaded (5 entries)
# ✓ Socratic RAG System v7.0 initialized successfully!
# [23:22:56] ConflictDetector: Error in semantic conflict detection: '<=' not supported between instances of 'int' and 'MagicMock'
# ✓ Conflict detection scenario test passed - detected 1 conflicts
#
#
# Added knowledge entry: test_entry
# Ran 39 tests in 12.533s
#
# FAILED (errors=19)
