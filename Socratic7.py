        ...
        default_knowledge = [
            {
                ...
                'content': 'Common software architecture patterns include MVC (Model-View-Controller), MVP (Model-View-Presenter), MVVM (Model-View-ViewModel), microservices architecture, layered architecture, and event-driven architecture. Each pattern has specific use cases and trade-offs.',
                'category': 'architecture',
                'metadata': {'topic': 'patterns', 'difficulty': 'intermediate'}
            },
            {
                'id': 'python_best_practices',
                'content': 'Python best practices include following PEP 8 style guide, using virtual environments, writing docstrings, implementing proper error handling, using type hints, following the principle of least privilege, and writing unit tests.',
                'category': 'python',
