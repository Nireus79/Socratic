...
# # 2025-08-21 21:14:54,835 - __main__ - ERROR - CLI error: Object of type datetime is not JSON serializable
# import os
# import json
# import hashlib
# import datetime
...
#     if not api_key:
#         print(f"{Fore.YELLOW}API_KEY_CLAUDE not found in environment.")
